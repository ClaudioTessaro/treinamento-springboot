...
import br.com.tessaro.app.dto.obra.NomeAutoresDTO;
...
public class ObraService {
	...
	private List<Autor> mapearAutores(List<NomeAutoresDTO> autores, Obra obra) {
		List<Autor> autoress = new ArrayList<>();
		for (NomeAutoresDTO nomeAutor: autores) {
